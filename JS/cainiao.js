...
$request.url.indexOf("mtop.cainiao.nbpresentation.protocol.homepage.get.cn")
  ? d.data?.result?.dataList?.length > 0 &&
    (d.data.result.dataList = d.data.result.dataList.filter(
      (d) => "big_banner_area_v870" != d.type
    ))
  : -1 != $request.url.indexOf("mtop.cainiao.guoguo.nbnetflow.ads.mshow")
  ? (d.data["1308"] && delete d.data["1308"],
    d.data["1275"] && delete d.data["1275"])
